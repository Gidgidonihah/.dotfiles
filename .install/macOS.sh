...
# TODO: incorporate things from https://git.herrbischoff.com/awesome-macos-command-line/about/
...
# See https://github.com/mathiasbynens/dotfiles/issues/310
# and https://github.com/mathiasbynens/dotfiles/pull/774 for more information
...
# Alternatively, here is an applescript way of doing things
# osascript -e '
...
do
  if [ "$APP" = 'SPACER' ]; then
    ...
    APPNAME="/Applications/$APP.app"
    defaults write com.apple.dock persistent-apps -array-add "<dict><key>tile-data</key><dict><key>file-data</key><dict><key>_CFURLString</key><string>$APPNAME</string><key>_CFURLStringType</key><integer>0</integer></dict></dict></dict>"
  fi
done
